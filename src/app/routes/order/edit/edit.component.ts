...
export class OrderEditComponent implements OnInit {
  ...
  ngOnInit() {
    this.orderForm = new FormGroup({
      ...
      paymentStatus: new FormControl(10, []),
      shippingStatus: new FormControl(0, []),
      orderType: new FormControl(2, []),
      orderSource: new FormControl(10, []),
      adminComment: new FormControl(null, []),
      customerComment: new FormControl(null, []),
      shippingProvinceId: new FormControl(null, [Validators.required]),
      shippingCityId: new FormControl(null, [Validators.required]),
      shippingDistrictId: new FormControl(null, [Validators.required]),
      shippingAddress: new FormControl(null, [Validators.required]),
      shippingPhoneNumber: new FormControl(null, [Validators.required]),
      shippingName: new FormControl(null, [Validators.required]),
      subtotalAmount: new FormControl(0, []),
      totalAmount: new FormControl(0, []),
      shippingAmount: new FormControl(0, []),
      rewardAmount: new FormControl(0, []),
      paymentMethodAdditionalFee: new FormControl(0, []),
      discountAmount: new FormControl(0, []),
      subTotalDiscountAmount: new FormControl(0, []),
      refundedAmount: new FormControl(0, []),
    ...
    this.orderItemForm = new FormGroup({
      orderItemNumber: new FormControl(null, []),
