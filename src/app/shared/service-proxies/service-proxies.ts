...
export class AuditLogServiceProxy {
     ...
     * @maxResultCount (optional) 最大结果数量(等同:PageSize)
     * @skipCount (optional) 列表跳过数量(等同: PageSize*PageIndex)
     * @return Success
     */
...
export class EditionServiceProxy {
     ...
     * @addAllItem (optional) 添加所有
     * @onlyFreeItems (optional) 只获取免费版
     * @return Success
     */
...
export class LanguageServiceProxy {
    ...
    /**
     * 获取语言翻译
     * @maxResultCount (optional) 结果数量(页大小)
     * @skipCount (optional) 跳过数量(页大小 * 页码)
     * @sorting (optional) 排序字段(eg : Key Desc )
     * @sourceName 源名称(eg:Vapps,AbpZero,Abp)
...
export class OrganizationUnitServiceProxy {
    ...
    /**
     * 把成员从组织单位移除
     * @userId (optional) 用户 Id(大于0)
     * @organizationUnitId (optional) 组织单位 Id(大于0)
     * @return Success
     */
...
export class PictureServiceProxy {
    ...
    /**
     * 获取分组下的图片
     * @groupId (optional) 图片分组Id，-1 获取全部
     * @sorting (optional) 排序字段 (eg:Id DESC)
     * @maxResultCount (optional) 最大结果数量(等同:PageSize)
     * @skipCount (optional) 列表跳过数量(等同: PageSize*PageIndex)
     * @return Success
...
export class ProfileServiceProxy {
    ...
    /**
     * 根据 Id 获取头像
     * @profilePictureId (optional) 头像文件Id
     * @return Success
     */
...
export class StateServiceServiceProxy {
    ...
    /**
     * 获取所有城市
     * @provinceId (optional) 省份Id(必须大于0)
     * @sorting (optional) 排序字段 (eg:Id DESC)
     * @maxResultCount (optional) 最大结果数量(等同:PageSize)
     * @skipCount (optional) 列表跳过数量(等同: PageSize*PageIndex)
     * @return Success
...
export class TenantServiceProxy {
     ...
     * @editionIdSpecified (optional) 指定版本
...
export class TimingServiceProxy {
    ...
    /**
     * 获取所有时区
     * @defaultTimezoneScope (optional) 默认时区有效范围
     * @return Success
     */
...
export class UserServiceProxy {
     ...
     * @permission (optional) 权限
     * @roleIds (optional) 角色
     * @onlyLockedUsers (optional) 只获取锁定用户
     * @sorting (optional) 排序字段 (eg:Id DESC)
     * @maxResultCount (optional) 最大结果数量(等同:PageSize)
     * @skipCount (optional) 列表跳过数量(等同: PageSize*PageIndex)
     * @return Success
...
export class SMSSettingsEditDto implements ISMSSettingsEditDto {
    ...
    /** 可用短信模板 */
    availableSmsTemplates: SelectListItemDto[] | undefined;
