...
describe('pro: layout-pro-menu', () => {
  ...
  describe('#menu', () => {
    it('should be ingored category menus', () => {
      page.appendMenu([
            { text: '1', children: [ { text: '1-1'}, { text: '1-2'} ] }
          ])
          .checkCount(2);
    });
    ...
    it('should be ingored menu item when _hidden is true', () => {
      page.appendMenu([
            { text: '1', children: [ { text: '1-1', hide: true }, { text: '1-2'} ] }
          ])
          .checkCount(1);
    });

    it('should be navigate router', (done) => {
      const router = injector.get(Router) as Router;
      spyOn(router, 'navigateByUrl');
      page.appendMenu([
            { text: '1', children: [ { text: '1-1', link: '/' } ] }
          ])
          .click()
          .whenStable().then(() => {
    ...
    it('should be auto closed collapse when router changed of mobile', (done) => {
